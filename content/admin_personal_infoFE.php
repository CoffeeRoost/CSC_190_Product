        ...
        <div class="mb-5">
                <fieldset class="border rounded-3 p-3">
                        ...
                        <div id ="empNameEdit" style="transition:1ms;" class ="collapse collapse">
                                ...
                                <form method="POST" action="./includes/employeeModifyFunction.inc.php?role=admin">
                                        <div  class="row my-2">
                                                <div class="col-4 fw-bold">ID</div>
                                                <div class="col-7"><?php echo $_SESSION['empViewID']?></div>
                                        ...
                                        <div  class="row my-2">
                                                ...
                                                <div class="col-7">
                                                        <select class="form-select-SM border rounded-2" name="empRole" id="empRole">
                                                                <option value="Manager" <?php echo ($_SESSION['empViewRole'] === 'Manager') ? 'selected' : 'disabled'; ?>>Manager</option>
                                                                <option value="Supervisor"<?php echo ($_SESSION['empViewRole'] === 'Supervisor') ? 'selected' : 'disabled'; ?>>Supervisor</option>
                                                                <option value="Developer"<?php echo ($_SESSION['empViewRole'] === 'Developer') ? 'selected' : 'disabled'; ?>>Developer</option>
                                                                <option value="Designer"<?php echo ($_SESSION['empViewRole'] === 'Designer') ? 'selected' : 'disabled'; ?>>Designer</option>
                                                                <option value="Administrator"<?php echo ($_SESSION['empViewRole'] === 'Administrator') ? 'selected' : 'disabled'; ?>>Administrator</option>
                                                                <option value="Admin"<?php echo ($_SESSION['empViewRole'] === 'Admin') ? 'selected' : 'disabled'; ?>>Administrator (System Admin)*</option>
                                                                <option value="Analyst"<?php echo ($_SESSION['empViewRole'] === 'Analyst') ? 'selected' : 'disabled'; ?>>Analyst</option>
                                                                <option value="Consultant"<?php echo ($_SESSION['empViewRole'] === 'Consultant') ? 'selected' : 'disabled'; ?>>Consultant</option>
                                                                <option value="Salesperson"<?php echo ($_SESSION['empViewRole'] === 'Salesperson') ? 'selected' : 'disabled'; ?>>Salesperson</option>
                                                                <option value="Customer Service Representative"<?php echo ($_SESSION['empViewRole'] === 'Customer Service Representative') ? 'selected' : 'disabled'; ?>>Customer Service Representative</option>
                                                        </select>
                                                </div>
