        ...
        <div class="boxSurvey my-1">
		  ...
		  <div id="survey1" style="transition: 1ms" class="collapse show">
                ...
                <div class="bg-white my-3 border rounded-3">
                    ...
                    <br>
                    <input type="text" name="state" id="state" class="m-2 input-underline" placeholder="Your answer" required>
                </div>
                ...
                <div class="bg-white my-3 border rounded-3">
                    ...
                    <br>
                    <input type="text" name="mailStreet" id="mailStreet" class="m-2 input-underline" placeholder="Your answer" required>
                </div>
			  ...
			  <button type="button" data-bs-toggle="collapse" data-bs-target="#survey2,#survey1" class="btn btn-primary">Next</button>
                </div>
		  </div>
		  ...
		  <div id="survey2" style="transition: 1ms" class="collapse">
                ...
                <div class="bg-white my-3 border rounded-3">
                    ...
                    <select class="form-select-SM m-2 border rounded-2" name="race" id="race" required>
                        <option value="" disabled selected hidden>Choose</option>
                ...
                <div class="d-flex justify-content-between m-1">
                    ...
                    <button type="button" data-bs-toggle="collapse" data-bs-target="#survey3,#survey2" class="btn btn-primary">Next</button>
                </div>
		  </div>
		  ...
		  <div id="survey3" style="transition: 1ms" class="collapse">
                ...
                <div class="bg-white my-3 border rounded-3">
                    ...
                    <br>
                    <div class="form-check m-2">
                        <input class="form-check-input" type="radio" name="ui" id="claimant" value="Claimant" required>
                ...
                <div class="d-flex justify-content-between m-1">
                    ...
                    <button type="button" data-bs-toggle="collapse" data-bs-target="#survey4,#survey3" class="btn btn-primary">Next</button>
                </div>
		  </div>
		  ...
		  <div id="survey5" style="transition: 1ms" class="collapse">
		    ...
		    <div class="bg-white my-3 border rounded-3">
                    ...
                    <br>
                    <input type="password" name="password" id="password" class="m-2 input-underline" placeholder="Your answer" required>
                </div>
		    ...
		    <div class="bg-white my-3 border rounded-3">
                ...
                <div class="d-flex justify-content-between m-1">
                    ...
                    <button name="signup-submit" type = "submit"class="btn btn-primary"><a class="text-decoration-none text-white" href="./checkEmail.php">Submit </a></button>
		    </div>
		  </div>
            </form>
        </div>
