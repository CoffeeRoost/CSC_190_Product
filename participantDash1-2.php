...
$query = "SELECT part.userID,part.fname,part.lname,part.MI,part.email,part.newUserPassword,part.last4SSN,part.programPartnerReference,
                 ...
                 e.desiredJobTitle,e.techExperience,e.selectiveService,
...
//  Display some personal information from the database tables using php 
                      // Fetch the data
                          while($row=mysqli_fetch_assoc($result)){
                            ...
                            $disabilityDesc =$row['disabilityDescription'];
            ...
            <form action="includes/editParticipantInfo.inc.php" method="post">
                <div id="survey1" style="transition: 1ms" class="collapse show">
                    ...
                    <div class="bg-white my-3 border rounded-3">
                        ...
                        <div class="form-check m-2">
                            <?php if (!$mailingStreet && !$mailingCity && !$mailingCountry && !$mailingState && !$mailingZipcode) { ?>
                    ...
                    <div class="d-flex justify-content-between m-1">
                        <button type="button" data-bs-toggle="collapse" style="border:none;"></button>
                ...
                <div id="survey2" style="transition: 1ms" class="collapse">
                    ...
                    <div class="bg-white my-3 border rounded-3">
                        ...
                        <?php } else { ?>
                            <input type="number" name="uscisNumber" id="uscisNumber" class="m-2 input-underline" placeholder="Your Answer">
                        <?php } ?>
                        ...
                        <?php } else { ?>
                            <input type="date" id="uscisExpired" name="uscisExpired" class="m-2 input-underline" placeholder="Your Answer">
                        <?php } ?>
                    </div>
                    ...
                    <div class="bg-white my-3 border rounded-3">
                        ...
                        <br>
                        <div class="form-check m-2">
                            <?php if ($selectiveService=='Yes') { ?>
                                <input class="form-check-input" type="radio" name="selective" id="yselective" value="Yes" checked="checked">
                            <?php } else { ?>
                        ...
                        <div class="form-check m-2">
                            <?php if ($selectiveService=='No') { ?>
                                <input class="form-check-input" type="radio" name="selective" id="nonSelective" value="No" checked="checked">
                            <?php } else { ?>
                        ...
                        <div class="form-check m-2">
                            <?php if ($selectiveService=='Documented exemption') { ?>
                                <input class="form-check-input" type="radio" name="selective" id="docExemption" value="Documented exemption" checked="checked">
                            <?php } else { ?>
                        ...
                        <div class="form-check m-2">
                            <?php if ($selectiveService=='Not applicable') { ?>
                                <input class="form-check-input" type="radio" name="selective" id="notApplicable" value="Not applicable" checked="checked">
                            <?php } else { ?>
                    ...
                    <div class="bg-white my-3 border rounded-3">
                        ...
                        <br>
                        <div class="form-check m-2">
                            <?php if ($isDisability=='Yes') { ?>
                                <input class="form-check-input" type="radio" name="disability" id="ydisability" value="Yes" checked="checked">
                            <?php } else { ?>
                        ...
                        <div class="form-check m-2">
                            <?php if ($isDisability=='No') { ?>
                                <input class="form-check-input" type="radio" name="disability" id="nonDisability" value="No" checked="checked">
                            <?php } else { ?>
                    ...
                    <div class="bg-white my-3 border rounded-3">
                        ...
                        <br>
                        <?php if ($isDisability=='Yes') { ?>
                            <input type="text" name="typeDisability" id="typeDisability" class="m-2 input-underline" value="<?php echo $disabilityDesc?>">
                        <?php } else { ?>
                ...
                <div id="survey3" style="transition: 1ms" class="collapse">
                    ...
                    <div class="bg-white my-3 border rounded-3">
                        ...
                        <br>
                        <?php if ($employmentStatus=='Employed' || $employmentStatus=='Employed but received notice of termination or separation from military service') { ?>
                            <input type="number" name="payRate" id="payRate" class="m-2 input-underline" value="<?php echo $payRate?>">
                        <?php } else { ?>
                    ...
                    <div class="bg-white my-3 border rounded-3">
                        ...
                        <br>
                        <?php if ($employmentStatus=='Not Employed') { ?>
                            <input type="number" name="uiWeek" id="uiWeek" class="m-2 input-underline" value="<?php echo $unemploymentWeeks?>">
                        <?php } else { ?>
                    ...
                    <div class="bg-white my-3 border rounded-3">
                        ...
                        <br>
                        <input type="text" name="jobTitle" id="jobTitle" class="m-2 input-underline" value="<?php echo $desiredJobTitle?>">
                    </div>
                ...
                <div id="survey4" style="transition: 1ms" class="collapse">
                    ...
                    <div class="bg-white my-3 border rounded-3">
                        ...
                        <br>
                        <?php if ($youthBuild=='Yes') { ?>
                            <input type="text" name="youthGrantNum" id="youthGrantNum" class="m-2 input-underline" value="<?php echo $youthBuildGrant?>">
                        <?php } else { ?>
                ...
                <div id="survey5" style="transition: 1ms" class="collapse">
                    ...
                    <div class="bg-white my-3 border rounded-3">
                        ...
                        <br>
                        <?php if ($familySize) { ?>
                            <input type="number" name="familySize" id="familySize" class="m-2 input-underline" value="<?php echo $familySize?>">
                        <?php } else { ?>
                    ...
                    <div class="bg-white my-3 border rounded-3">
                        ...
                        <br>
                        <?php if ($annualizedFamilyIncome) { ?>
                            <input type="number" name="annualIncome" id="annualIncome" class="m-2 input-underline" value="<?php echo $annualizedFamilyIncome?>">
                        <?php } else { ?>
